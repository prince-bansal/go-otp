...
func NewRouter(handler *organisation.OrganisationHandler, healthHandler *health.HealthHandler, keyHandler *apiKey.ApiKeyHandler, otpHandler *otp.OtpHandler) *Router {
	return &Router{
